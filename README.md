...
Crystal-NN is a free, powerful UCI chess engine derived from Crystal ([https://github.com/jhellis3/Stockfish/tree/crystal.)] Joseph Ellis author-
...
Chess Partner or Fritz) in order to be used comfortably. Read the documentation for your GUI of choice for information about how to use Crystal-NN with it.

This version of Crystal-NN has support for Syzygybases.
...
This distribution of Crystal consists of the following files:
  ...
  * source, a subdirectory containing the full source code, including a Makefile
    that can be used to compile Crystal on Unix-like systems.
