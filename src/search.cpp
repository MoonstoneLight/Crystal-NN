...
namespace {
  ...
  Value search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {
    ...
    //from Kelly begin
	Value bestValue, value, ttValue, eval=VALUE_NONE, expTTValue=VALUE_NONE;
    bool ttHit, ttPv, inCheck, givesCheck, improving, didLMR, priorCapture, isMate, gameCycle, expTTHit=false;
    //from Kelly End
